...
To get started, you'll need an API key and a World ID. You can get these from the [Worlds Console](https://worlds.wazoo.tech).
...
const world = new World({
  baseUrl: "https://api.worlds.wazoo.tech/v1",
  apiKey: "YOUR_API_KEY",
